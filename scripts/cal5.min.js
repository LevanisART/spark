...
var locID = $("#hLocationID").val(), contact_ID = $("#hContactID").val(), tz, startDate = $("#hStartDate").val(), stopEndlessLoopOfMonths = 0;
$(document).ready(function() {
  ...
  $(".responsive-calendar").responsiveCalendar({
      ...
      onDayClick: function(n) {
          var t = this.attributes["data-month"].value, i = this.attributes["data-day"].value, r = this.attributes["data-year"].value, o = r + "-" + t + "-" + i, u, f, e;
          i.length === 1 && (i = "0" + i);
          t.length === 1 && (t = "0" + t);
          u = r + "-" + t + "-" + i;
